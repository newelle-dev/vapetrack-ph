...
- [ ] Create the validation schema `lib/validations/inventory.ts`:
...
- [ ] Add inventory-related types to `types/index.ts` by appending the following after the existing exports:
...
- [ ] Create the server actions file `app/actions/inventory.ts`:
...
- [ ] No TypeScript build errors: `npx tsc --noEmit` passes
- [ ] Import paths resolve correctly
- [ ] Types are properly exported from `types/index.ts`
